...
type ListPaymentsRequest struct {
	...
	MinAmount float64 `protobuf:"fixed64,1,opt,name=min_amount,json=minAmount,proto3" json:"min_amount,omitempty"` // 0 = unlimited
	MaxAmount float64 `protobuf:"fixed64,2,opt,name=max_amount,json=maxAmount,proto3" json:"max_amount,omitempty"` // 0 = unlimited
}
...
func (x *ListPaymentsRequest) GetMinAmount() float64 {
	if x != nil {
		return x.MinAmount
	}
	return 0
...
func (x *ListPaymentsRequest) GetMaxAmount() float64 {
	if x != nil {
		return x.MaxAmount
	}
	return 0
...
var file_payment_v1_payment_proto_rawDesc = []byte{
	...
	0x22, 0x53, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x69, 0x6e, 0x5f, 0x61,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x4f, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x79,
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2a, 0x82, 0x01, 0x0a, 0x0d, 0x50, 0x61, 0x79, 0x6d, 0x65,
	...
	0x55, 0x53, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x32, 0xae, 0x01, 0x0a, 0x0e,
	...
	0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1f, 0x2e, 0x70, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65,
	0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x70, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x35, 0x5a, 0x33,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x5a, 0x4c, 0x48, 0x52, 0x53,
	0x2f, 0x61, 0x70, 0x32, 0x2d, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2f, 0x70,
...
var file_payment_v1_payment_proto_depIdxs = []int32{
	...
	5, // 1: payment.v1.PaymentResponse.created_at:type_name -> google.protobuf.Timestamp
	5, // 2: payment.v1.PaymentResponse.processed_at:type_name -> google.protobuf.Timestamp
	2, // 3: payment.v1.ListPaymentsResponse.payments:type_name -> payment.v1.PaymentResponse
	1, // 4: payment.v1.PaymentService.ProcessPayment:input_type -> payment.v1.PaymentRequest
	3, // 5: payment.v1.PaymentService.ListPayments:input_type -> payment.v1.ListPaymentsRequest
	2, // 6: payment.v1.PaymentService.ProcessPayment:output_type -> payment.v1.PaymentResponse
	4, // 7: payment.v1.PaymentService.ListPayments:output_type -> payment.v1.ListPaymentsResponse
